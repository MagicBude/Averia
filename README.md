...
- Node.js 22.21 或更高版本（推荐 Node 24；V0.3.2 自动代理依赖 Node 内置代理能力）
- pnpm 11.21.0（CI 固定版本）
...
支持 Windows 原生目录选择、手动扫描、精确番号关联、文件搜索、继续观看、浏览器直接播放和同目录改名预览/确认。
媒体索引保存在 `var/media/library.db`；尚未支持转码、跨目录移动、删除或无法精确匹配时的人工关联。
